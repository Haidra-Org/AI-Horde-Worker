...
arg_parser.add_argument(
    "--queue_size", type=int, required=False, help="How many requests to keep in the queue. Min: 0",
)
arg_parser.add_argument(
    "--allow_unsafe_ip",
    action="store_true",
...
arg_parser.add_argument(
    "--max_threads", type=int, required=False, help="How many threads to use. Min: 1",
)
arg_parser.add_argument(
    "-v",
    "--verbosity",
